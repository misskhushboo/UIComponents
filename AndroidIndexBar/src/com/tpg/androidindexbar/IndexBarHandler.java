...
public class IndexBarHandler extends Handler {
	 ...
	 * @param indexbar
	 */
	public IndexBarHandler(IndexBar indexbar) {
	...
	public void handleMessage(Message msg) {
		if (msg.what == 1) {
			...
			ListView alphabets_listview=(ListView)indexbar.findViewById(R.id.listView_alphabets);
			...
			ArrayAdapter<String> alphabets_adapter=	new AlphabetListviewAdapter(indexbar.getBaseContext(),R.layout.alphabtes_row,alphabets_list, number_of_characters_omit);
			alphabets_listview.setAdapter(alphabets_adapter);
			alphabets_listview.setOnItemClickListener(indexbar);
		}
	}
